...
EOF
    ...
    *)
        ...
        echo "  env        - 환경 변수 포맷 출력 (기본값)"
        echo "  json       - JSON 포맷 출력"
        echo "  docker-args - Docker 빌드 인자 포맷 출력"
        echo "  ldflags    - Go ldflags 포맷 출력"
        echo "  info       - 정보 포맷 출력"
        exit 1
        ;;
esac