...
const (
	// MiniMaxBaseURL MiniMax global API BaseURL
	MiniMaxBaseURL = "https://api.minimax.io/v1"
	// MiniMaxCNBaseURL MiniMax China API BaseURL
	MiniMaxCNBaseURL = "https://api.minimaxi.com/v1"
)

// MiniMaxProvider implements the MiniMax provider interface
...
// Info returns metadata for MiniMax provider
...
// ValidateConfig validates MiniMax provider config
