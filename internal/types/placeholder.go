...
var (
	...
	PlaceholderQuery = PromptPlaceholder{
		Name:        "query",
		Label:       "사용자 질문",
		Description: "사용자의 현재 질문 또는 조회 내용",
	}
	...
	PlaceholderConversation = PromptPlaceholder{
		Name:        "conversation",
		Label:       "대화 기록",
		Description: "다중 턴 재작성에 사용하는 서식화된 대화 기록",
	}
	...
	PlaceholderAnswer = PromptPlaceholder{
		Name:        "answer",
		Label:       "어시스턴트 답변",
		Description: "어시스턴트의 답변 내용(대화 기록 서식화용)",
	}
	...
	PlaceholderKnowledgeBases = PromptPlaceholder{
		...
		Label:       "지식베이스 목록",
		Description: "자동으로 서식화된 지식베이스 목록(이름, 설명, 문서 수 등 포함)",
	}

	PlaceholderWebSearchStatus = PromptPlaceholder{
		Name:        "web_search_status",
		Label:       "웹 검색 상태",
		Description: "웹 검색 도구 활성화 여부(Enabled/Disabled)",
	}
)
